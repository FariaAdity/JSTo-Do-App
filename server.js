...
async function go() {
  let client = new MongoClient('mongodb+srv://adity:ms9%407m8n7k-AdPr@cluster0.k7rp2uu.mongodb.net/ToDoApp?retryWrites=true&w=majority')
...
function passwordProtected(req, res, next) {
  ...
  if (req.headers.authorization == "Basic YWRpdHk6MTIzZGl0eQ==") {
    next()
  } else {
